...
def upload_image_and_get_id(data, labDirectoryPath):
    result = {
    ...
    try:
        ...
        with open(labDirectoryPath + 'data.json', 'r') as file:
        ...
        # Upload the image
        files = {'file': ('valid_image.jpg', open(labDirectoryPath + 'valid_image.jpg', 'rb'), 'image/jpeg')}
...
def check_bucket(data, labDirectoryPath, uploaded_image_name):
    result = {
    ...
    try:
        ...
        with open(labDirectoryPath + 'data.json') as f:
        ...
        input_image = cv2.imread(labDirectoryPath + 'valid_image.jpg')
        uploaded_image = cv2.imread(labDirectoryPath + 'uploaded_image.jpg')
...
def check_label_bucket(data, labDirectoryPath, image_name):
    result = {
...
def check_lambda_trigger(data, labDirectoryPath, image):
    result = {
...
def main():
    ...
    # Example usage
    image_id = upload_image_and_get_id(data, labDirectoryPath)
    if image_id:
        flag = check_bucket(data, labDirectoryPath, image_id)
        if flag:
            check_label_bucket(data, labDirectoryPath, image_id)
            time.sleep(5)
            check_lambda_trigger(data, labDirectoryPath,image_id)
        else:
